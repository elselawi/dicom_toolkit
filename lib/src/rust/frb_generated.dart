...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  DicomMetadata dco_decode_dicom_metadata(final dynamic raw) {
    ...
    return DicomMetadata(
      ...
      seriesDate: dco_decode_String(arr[3]),
      acquisitionDate: dco_decode_String(arr[4]),
      contentDate: dco_decode_String(arr[5]),
      studyDescription: dco_decode_String(arr[6]),
      modality: dco_decode_String(arr[7]),
      manufacturer: dco_decode_String(arr[8]),
      manufacturerModelName: dco_decode_String(arr[9]),
      institutionName: dco_decode_String(arr[10]),
      studyInstanceUid: dco_decode_String(arr[11]),
      seriesInstanceUid: dco_decode_String(arr[12]),
      sopInstanceUid: dco_decode_String(arr[13]),
      seriesDescription: dco_decode_String(arr[14]),
      bodyPartExamined: dco_decode_String(arr[15]),
      toothInfo: dco_decode_String(arr[16]),
      sliceThickness: dco_decode_f_32(arr[17]),
      instanceNumber: dco_decode_String(arr[18]),
      photometricInterpretation: dco_decode_String(arr[19]),
      width: dco_decode_u_32(arr[20]),
      height: dco_decode_u_32(arr[21]),
      windowCenter: dco_decode_f_32(arr[22]),
      windowWidth: dco_decode_f_32(arr[23]),
      rescaleIntercept: dco_decode_f_32(arr[24]),
      rescaleSlope: dco_decode_f_32(arr[25]),
      samplesPerPixel: dco_decode_u_16(arr[26]),
      bitsAllocated: dco_decode_u_16(arr[27]),
      bitsStored: dco_decode_u_16(arr[28]),
  ...
  DicomMetadata sse_decode_dicom_metadata(final SseDeserializer deserializer) {
    ...
    final var_seriesDate = sse_decode_String(deserializer);
    final var_acquisitionDate = sse_decode_String(deserializer);
    final var_contentDate = sse_decode_String(deserializer);
    ...
    final var_toothInfo = sse_decode_String(deserializer);
    ...
    return DicomMetadata(
        ...
        seriesDate: var_seriesDate,
        acquisitionDate: var_acquisitionDate,
        contentDate: var_contentDate,
  ...
  void sse_encode_dicom_metadata(
    ...
    sse_encode_String(self.seriesDate, serializer);
    sse_encode_String(self.acquisitionDate, serializer);
    sse_encode_String(self.contentDate, serializer);
    ...
    sse_encode_String(self.toothInfo, serializer);
